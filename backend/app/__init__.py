...
def create_app():
    ...
    from .routes import main_routes, auth_routes, citas_routes, usuario_routes, paciente_routes, inventario_routes, procedimientos_routes_routes,personal_routes, consultorios_routes, servicios_routes
